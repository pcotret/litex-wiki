...
When the `valid` signal is asserted, the data is clocked read by the module. In the example above, you can see that it is clocked into the transfer register of the UART.

the whole trace of the above example looks like this:
