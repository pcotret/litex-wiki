...
* n integer (default 2): depth of flip flop chain
* reset integer (default 0): reset value
...
* i Signal() _implicit_: input signal to synchronize
* o Signal() _implicit_: output signal to synchronize
