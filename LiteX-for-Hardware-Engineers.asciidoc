...
clock edge later. It appears one can use both direct and NextValue at the same
time, and this will cause the value to change upon entering the state and it
