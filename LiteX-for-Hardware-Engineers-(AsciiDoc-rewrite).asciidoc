...
NOTE: This is a work-in-progress rewrite of the original documentation in AsciiDoc, for better code formatting.

Experienced Python engineers can skip this and https://github.com/m-labs/migen[read the source code] for
documentation.
...
To be written -- how to create CSRs, access bits, get them into your clock domain, and
prevent false timing paths
